...
const requests = {
  ...
  fetchNetflixOriginals: `/discover/tv?api_key=${AIP_KEY}&with_networks=213`,
  ...
  fetchRomaceMovies: `/discover/movie?api_key=${AIP_KEY}&with_genres=10749`,
  fetchDocumentaries: `/discover/movie?api_key=${AIP_KEY}&with_genres=99`,
};
